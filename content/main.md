...
- 但高fps录制情况下，显卡在极短的时间内去频繁计算和调整码率波动，反而会增加额外的计算负担。而且如果“最大码率”给得不够高，剧烈运动时依然会发糊。

**4. 无损 (Lossless)**
- 原理： 字面意思，放弃所有的有损压缩算法，100%像素级保留原始画面。
- 表现： 无敌画质，无敌大小，**显卡硬盘双双爆炸**。
- 文件体积极其恐怖，一分钟可能高达十几个GB，别作死了。
...
- 表现： 兼容性震撼亚洲，哪怕是北福的破烂win7或酥桃的农企速龙750ti都能流畅播放。但**压缩效率极差**，这意味着在相同的码率设置下，它生成的文件会比另外两个**更大**，或者在固定码率下画质最糊。

**2. main (主配置)**
- 特点： 开启了中等复杂度的算法，支持B帧。
- **表**现： 曾在很长一段时间(来源请求¿)里是网页视频的主流标准，在画质和老设备兼容性之间取得了平衡。
...
- **2.** 如果开启了“心理视觉调整”，编码器可能会在高速运动时悄悄抹除某些它认为“不重要”的像素细节，导致原素材里出现微小的马赛克或像素断层（人眼看不出，但插件看得出）。这会直接导致算出来的动态模糊边缘出现诡异的**果！冻！**效应或脏斑。
...
**底层逻辑**：
**1. 709 (Rec. 709 / BT.709)：高清视频的绝对标准**
- 特点： 目前所有高清视频的国际通用色彩标准。洼球绝大多数的显示器、视频网站以及播放器，都是默认以709标准来解析高清视频的色彩的。
- 表现：颜色准确，兼容性最好。

**2.** **601 (Rec. 601 / BT.601)：已被淘汰的标清时代老标准**
...
**3. sRGB：电脑显示器与图文的标准**
- 特点： sRGB 主要用于电脑屏幕、网页浏览和静态图片。和 709 能表现的色彩范围其实是**一模一样**的。
...
踩坑「**重灾区**」，单从字面上看，“完整”似乎优于“局部”，洼人劣根性导致其会**本能**地想选Full。但在专业的视频录制和剪辑领域，**请相信软件作者比你懂软件，他标推荐是有他的道理的。**
**1. 色阶范围**
...
也就是说Full没那么可怕，只是自带额外饱和度而已。与Couleur一样，我也对所有颜色格式、空间和范围的了解不多，欢迎大家提出建议。
![Image_30](/images/30.jpg)
...
##### 3.2. Vegas
还在填，这个设置你可以照抄
![Image_30](/images/30.png)![Image_31](/images/31.png)![Image_32](/images/32.png)![Image_33](/images/33.png)![Image_34](/images/34.png)![Image_35](/images/35.png)![Image_36](/images/36.png)![Image_37](/images/37.png)![Image_38](/images/38.png)![Image_39](/images/39.png)![Image_40](/images/40.png)![Image_41](/images/41.png)
